 ...
 * @author adria
 */
public class Beratbadanaplikasi extends javax.swing.JFrame{
    int berat = 0;
    double tinggi = 0;
    double tinggi2 = 0;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Beratbadanaplikasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Beratbadanaplikasi().setVisible(true);
            }
        });
    }
